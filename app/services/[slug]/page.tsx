...
import { environments, type Environment } from "@/lib/db/schema";
import { environmentLabels, stateLabels } from "@/lib/deployments/presentation";

type ServiceDetails = NonNullable<ReturnType<typeof getServiceDetails>>;
  ...
  return (
    <PageContainer>
      ...
      <PageContent>
        ...
        />
        <DeploymentHistory service={service} environment={environment} />
      </PageContent>
    </PageContainer>
  );
}

function ServiceSummary({ service }: { service: ServiceDetails }) {
  return (
...
function DeploymentHistory({ service, environment }: { service: ServiceDetails; environment: Environment }) {
  return (
